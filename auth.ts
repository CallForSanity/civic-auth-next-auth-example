...
export const { handlers, auth, signIn, signOut } = NextAuth({
  ...
  providers: [
    ...
    Zoom,*/
    {
      ...
      /*authorization: {
        url: "https://auth.civic.com/oauth/auth",
        ...
        async request(context: any) {
          const response = await fetch(context.provider.token.url as string, {
            ...
            body: new URLSearchParams({
              ...
              code_verifier: context.codeVerifier // PKCE code verifier
            }),
            method: 'POST',
          })
      ...
      clientId: "bebc7de6-2a82-45e7-8ccb-0b72198372de",
      //clientSecret: process.env.AUTH_CIVIC_SECRET,
    },
  ],
  basePath: "/auth",
